...
public class GeneratePDFForSpecificUser extends CustomJavaAction<java.lang.Boolean>
{
	...
	{
		this.PDFFile_ = this.__PDFFile_ == null ? null : system.proxies.FileDocument.initialize(getContext(), __PDFFile_);

		this.CustomOptions_ = this.__CustomOptions_ == null ? null : templator.proxies.Options.initialize(getContext(), __CustomOptions_);

		this.User_ = this.__User_ == null ? null : system.proxies.User.initialize(getContext(), __User_);
